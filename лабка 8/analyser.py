...
def main():
    ...
    df_1 = loader.get_historical_data("btc-usdt", datetime.strptime("2023-01-01", '%Y-%m-%d'), datetime.strptime("2023-01-02", '%Y-%m-%d'), Granularity.FIVE_MINUTES)
    df_2 = loader.get_historical_data("gmt-usdt", datetime.strptime("2023-01-01", '%Y-%m-%d'), datetime.strptime("2023-01-02", '%Y-%m-%d'), Granularity.FIVE_MINUTES)
    df_3 = loader.get_historical_data("eth-usdt", datetime.strptime("2023-01-01", '%Y-%m-%d'), datetime.strptime("2023-01-02", '%Y-%m-%d'), Granularity.FIVE_MINUTES)
